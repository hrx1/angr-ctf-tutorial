...
def main(argv):
  ...
  # start?
  # (!)
  start_address = 0x8048697 #dvije adrese ispod ispod poziva scanf
  ...
  if simulation.found:
    ...
    solution = ' '.join(map(str, [ solution0, solution1 ])) #Kopirano iz rjesenja. Kako da ja znam da ide razmak izmedju?
    print(solution)
  else:
